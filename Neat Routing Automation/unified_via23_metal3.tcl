...
gi::setField {viaAuto} -value {false} -in [gi::getToolbars {deCommandOptions} -from [gi::getWindows 2]]
gi::setField {viaDefName} -value {VIA23} -in [gi::getToolbars {deCommandOptions} -from [gi::getWindows 2]]
de::addPoint {4.410 8.721} -context [db::getNext [de::getContexts -window 2]]
...
gi::setField {viaAuto} -value {false} -in [gi::getToolbars {deCommandOptions} -from [gi::getWindows 2]]
gi::setField {viaDefName} -value {VIA23} -in [gi::getToolbars {deCommandOptions} -from [gi::getWindows 2]]
de::addPoint {4.410 9.289} -context [db::getNext [de::getContexts -window 2]]
...
le::createRectangle {{4.370 8.721} {4.450 9.791}} -design [ed] -lpp {M3 drawing} -net VDD
...
gi::setField {viaAuto} -value {false} -in [gi::getToolbars {deCommandOptions} -from [gi::getWindows 2]]
gi::setField {viaDefName} -value {VIA23} -in [gi::getToolbars {deCommandOptions} -from [gi::getWindows 2]]
de::addPoint {4.698 5.881} -context [db::getNext [de::getContexts -window 2]]
...
gi::setField {viaAuto} -value {false} -in [gi::getToolbars {deCommandOptions} -from [gi::getWindows 2]]
gi::setField {viaDefName} -value {VIA23} -in [gi::getToolbars {deCommandOptions} -from [gi::getWindows 2]]
de::addPoint {4.698 6.449} -context [db::getNext [de::getContexts -window 2]]

ile::createVia
gi::setField {viaAuto} -value {false} -in [gi::getToolbars {deCommandOptions} -from [gi::getWindows 2]]
gi::setField {viaDefName} -value {VIA23} -in [gi::getToolbars {deCommandOptions} -from [gi::getWindows 2]]
de::addPoint {4.698 7.017} -context [db::getNext [de::getContexts -window 2]]

ile::createVia
gi::setField {viaAuto} -value {false} -in [gi::getToolbars {deCommandOptions} -from [gi::getWindows 2]]
gi::setField {viaDefName} -value {VIA23} -in [gi::getToolbars {deCommandOptions} -from [gi::getWindows 2]]
de::addPoint {4.698 7.585} -context [db::getNext [de::getContexts -window 2]]

ile::createVia
gi::setField {viaAuto} -value {false} -in [gi::getToolbars {deCommandOptions} -from [gi::getWindows 2]]
gi::setField {viaDefName} -value {VIA23} -in [gi::getToolbars {deCommandOptions} -from [gi::getWindows 2]]
de::addPoint {4.698 8.153} -context [db::getNext [de::getContexts -window 2]]

# Metal3 Rectangle for VSS
le::createRectangle {{4.658 5.881} {4.738 8.153}} -design [ed] -lpp {M3 drawing} -net VSS
