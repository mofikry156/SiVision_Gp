...
# Auto-generated from Via12 database WITH TAPS INTEGRATION
# Window Number: 2
# X Start: 4.123 microns
# X Step: 0.287 microns
# Via Name: VIA23
# Device Y positions filtered: 7
# Tap rows integrated: 2
...
# ======================================================================
# TAPS INTEGRATION - Via23 and Metal3 for Power/Ground Rails
# ======================================================================

# Ptap at Y=5.681 (Net: VSS)
de::addPoint {4.123 5.681} -context [db::getNext [de::getContexts -window 2]]
le::createRectangle {{4.083 5.681} {4.163 6.181}} -design [ed] -lpp {M3 drawing} -net VSS

# Ntap at Y=9.857 (Net: VDD)
de::addPoint {4.123 9.857} -context [db::getNext [de::getContexts -window 2]]
le::createRectangle {{4.083 9.857} {4.163 10.357}} -design [ed] -lpp {M3 drawing} -net VDD

# Total tap rows integrated: 2
puts "Via23/Metal3 generation with taps integration complete"
